...
```{r plot-loglik-timing, fig.height=6, fig.width=9}
create_progress_plots(dat, fits, x="timing", y="loglik", numiter.prefit=300)
```

```{r plot-loglik-iter, fig.height=6, fig.width=9}
...
```{r plot-res-timing, fig.height=6, fig.width=9}
create_progress_plots(dat, fits, x="timing", y="res", numiter.prefit=300)
```

```{r plot-res-iter, fig.height=6, fig.width=9}
