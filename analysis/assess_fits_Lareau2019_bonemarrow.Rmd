...
library(ggplot2)
library(cowplot)
source("~/projects/scATACseq-topics/code/functions_for_assessing_fits.R")
```
...
create_progress_plots(dat, fits, "loglik", numiter.prefit = 300)
```
...
create_progress_plots(dat, fits, "res", numiter.prefit = 300)
```
