...
```{r motif-enrichment-ranking-plot-2, fig.width=4, fig.height=3.5, warning=FALSE}
print(plots[[1]])
```
...
```{r motif-enrichment-plot-2, fig.width=4, fig.height=3.5, warning=FALSE}
print(plots[[1]])
```
...
* Plot motif enrichment (-log10 p-value) and correlation between motif enrichment z-score and gene scores
* Rank motifs by motif enrichment (-log10 p-value) and correlation between motif enrichment z-score and gene scores

**Topic 1 example**
```{r motif-cor-plot, fig.width=4, fig.height=3.5, warning=FALSE}

motif_gene_mapping <- create_motif_gene_cor_scatterplot(motif_res, gene_scores, motif_names, gene_names, TF_genes, k = 1)

motif_gene_mapping <- motif_gene_mapping[with(motif_gene_mapping, order(motif_mlog10P*cor, decreasing = T)),]
...
```{r motif-gene-plot-1, fig.width=8, fig.height=5, warning=FALSE}
...
* Plot motif enrichment (zscore) and gene scores for GATA genes
```{r motif-gene-plot-2, fig.width=8, fig.height=5, warning=FALSE}
