...
```{r motif-cor-plot-1, fig.width=4, fig.height=3.5, warning=FALSE}
...
```{r motif-cor-plot-2, fig.width=4, fig.height=3.5, warning=FALSE}
...
* Plot motif enrichment (-log10 p-value) and gene scores
```{r motif-gene-plot-3, fig.width=8, fig.height=5, warning=FALSE}
...
* Plot motif enrichment (zscore) and gene scores
```{r motif-gene-plot-4, fig.width=8, fig.height=5, warning=FALSE}
