...
Motif enrichment (-log10 p-value) and rankings
...
```{r selected-motifs-p0.1, include=FALSE, eval=FALSE, fig.width=7, fig.height=6}
# Heatmap of motif enrichment for selected TF motifs
toMatch <- c("^GATA\\d*$", "^CEBP.?$", "^SPI.?$", "^IRF\\d*$", "^STAT\\d*$", "^TCF\\d*$", "^BCL\\d*$", "^CTCF$", "^ERG$")
selected_motifs <- grep(paste(toMatch,collapse="|"), motif_res$motifs$motif, ignore.case = T, value = T)
rows <- match(selected_motifs, motif_res$motifs$motif)
...
```{r selected-motifs-top1percent, include=FALSE, eval=FALSE, fig.width=7, fig.height=6}
# Heatmap of motif enrichment for selected TF motifs
toMatch <- c("^GATA\\d*$", "^CEBP.?$", "^SPI.?$", "^IRF\\d*$", "^STAT\\d*$", "^TCF\\d*$", "^BCL\\d*$", "^CTCF$", "^ERG$")
selected_motifs <- grep(paste(toMatch,collapse="|"), motif_res$motifs$motif, ignore.case = T, value = T)
rows <- match(selected_motifs, motif_res$motifs$motif)
...
```{r selected-motifs-top2000regions, include=FALSE, eval=FALSE, fig.width=7, fig.height=6}
# Heatmap of motif enrichment for selected TF motifs
toMatch <- c("^GATA\\d*$", "^CEBP.?$", "^SPI.?$", "^IRF\\d*$", "^STAT\\d*$", "^TCF\\d*$", "^BCL\\d*$", "^CTCF$", "^ERG$")
selected_motifs <- grep(paste(toMatch,collapse="|"), motif_res$motifs$motif, ignore.case = T, value = T)
rows <- match(selected_motifs, motif_res$motifs$motif)
