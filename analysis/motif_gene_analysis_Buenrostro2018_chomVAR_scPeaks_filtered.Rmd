---
title: "Motif and gene analysis using topic modeling results for Buenrostro *et al* (2018) scATAC-seq result (data processed using chromVAR processed counts with scPeaks and regions accessible in > 1% samples)"
author: Kaixuan Luo
output:
...
We use binarized scPeaks based on chromVAR processed counts with 
peaks accessible in > 1% samples.
...
based on chromVAR processed counts with peaks accessible in > 1% samples.
...
out.dir <- "/project2/xinhe/kevinluo/scATACseq-topics/output/Buenrostro_2018_chromVAR_scPeaks_filtered/binarized/"
