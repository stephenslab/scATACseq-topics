---
title: "Motif analysis using topic modeling results for Buenrostro *et al* (2018) scATAC-seq result (data processed using chromVAR processed counts on peaks called from Chen 2019)"
author: Kaixuan Luo
output:
...
```{r motif-heatmap-pvalue, fig.width=7, fig.height=11}
...
```{r plot-GATA-logos-1, fig.width=3, fig.height=1, warning=FALSE, message=FALSE}
k = 4
