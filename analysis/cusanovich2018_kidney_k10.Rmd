...
+ Create volcano plots for paper. In particular, volcano plots for
  topics 9 and 10 will go in the main text, and the remaining will go
  in the supplement. Also, fill out "selected top genes".
