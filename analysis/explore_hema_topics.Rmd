...
The A, B, C and GMP clusters clearly contain additional substructure
that might be worth a closer look. Interestingly, there are two large
subclusters in cluster A that don't map to the two cell types.

```{r, fig.height=2.75, fig.width=3.5, message=FALSE}
...
There is also some interesting substructure in cluster C, in
particular a quite distinct subcluster of MEP cells.
