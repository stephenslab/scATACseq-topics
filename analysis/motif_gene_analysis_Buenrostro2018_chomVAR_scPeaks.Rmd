---
title: "Motif and gene analysis using topic modeling results for Buenrostro *et al* (2018) scATAC-seq result (data processed using chromVAR processed counts with scPeaks)"
author: Kaixuan Luo
output:
...
based on chromVAR processed counts with scPeaks (> 1 sample).
...
```{r structure-plot, fig.width=7, fig.height=2.5}
set.seed(10)
...
RCC: `/project2/mstephens/kevinluo/scATACseq-topics/output/Buenrostro_2018_chromVAR_scPeaks/binarized/motifanalysis-Buenrostro2018-k=11-quantile/`
```{r top-motifs-1}
