...
This next Structure plot arranges the cells by the cluster labels
assigned by
[Cusanovich *et al*](https://doi.org/10.1016/j.cell.2018.06.052) (see
the "cell_type" column in Table S1).
...
identified by community detection (*Cusanovich et al* used the Louvain
