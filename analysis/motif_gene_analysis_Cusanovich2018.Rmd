---
title: "Motif and gene analysis using topic modeling results for Cusanovich *et al* (2018) scATAC-seq data"
author: Kaixuan Luo
output:
...
* Motif enrichment result using regions with abs(z-score) above 99% quantile.
RCC: `/project2/mstephens/kevinluo/scATACseq-topics/output/Cusanovich_2018/motifanalysis-Cusanovich2018-k=13-quantile/`
```{r top-motifs-1}
...
* Motif enrichment result using regions with zscore > 20.
RCC: `/project2/mstephens/kevinluo/scATACseq-topics/output/Cusanovich_2018/motifanalysis-Cusanovich2018-k=13-zscore/`
```{r top-motifs-2}
