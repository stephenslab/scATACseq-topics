...
```{r structure-plot-k15, fig.width=8, fig.height=3.5, message=FALSE}
set.seed(10)
...
Plot the distribution of tissues in each topic
...
```{r heatmap-tissues-topics-k20,  fig.width=7, fig.height=5}
...
```{r piechart-celllables-k20, fig.width=8, fig.height=8}
# Cells with membership > 5% in topic k20
...
topic_appearance <- as.matrix((fit_tissue$L > 0.05) + 0)

cat("Number of cells appear in each topic:\n")
colSums(topic_appearance)

p.structure <- structure_plot(fit_tissue,
