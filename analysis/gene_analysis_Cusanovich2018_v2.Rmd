...
<!--                                              file = sprintf("%s/volcano_topic_%s_%s.html", fig.dir, k, "TSS-absZ-sum"), -->
...
<!-- for ( k in 1:ncol(genescore_res$beta) ){ -->
<!--   p.volcano.plotly <- genescore_volcano_plotly(genescore_res,k, -->
<!--                                              file = sprintf("%s/volcano_topic_%s_%s.html", fig.dir, k, "genebody-absZ-sum"), -->
<!--                                              labels = genescore_res$genes$SYMBOL) -->
<!-- } -->
<!-- ``` -->
...
<!-- sig_genes <- rownames(gsea_res$pval)[which(gsea_res$pval[,k] < 1e-6)] -->
<!-- label_geneset_ids <- intersect(rownames(gsea_res$pval)[which(gsea_res$pval[,k] < 1e-6)],  -->
<!--                                gene_set_info[grep(name_interest, gene_set_info$name, ignore.case = T), "id"]) -->
...
<!--   saveWidget(p.gsea.plotly,file = sprintf("%s/gsea_topic_%s_%s.html", fig.dir, k, "TSS-absZ-sum"), -->
...
[volcano-plotly-tss-k1]: plotly/Cusanovich2018/volcano_topic_1_tss-absZ-sum.html
[volcano-plotly-genebody-k1]: plotly/Cusanovich2018/volcano_topic_1_genebody-absZ-sum.html
