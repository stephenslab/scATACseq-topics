---
title: "Clustering Buenrostro *et al* (2018) scATAC-seq data using topic proportions using chromVAR processed counts with scPeaks (> 1% samples)"
author: Kaixuan Luo
output:
...
clusters.merged[clusters.20 %in% c(2,20)] <- 2
clusters.merged[clusters.20 %in% c(5,11)] <- 5
