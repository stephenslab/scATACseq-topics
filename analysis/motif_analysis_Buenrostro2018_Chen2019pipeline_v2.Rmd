...
```{r region-volcano-plots, fig.width=10, fig.height=6}
...
```{r motif-cor-plot-2.1, fig.width=5, fig.height=4,  warning=FALSE}
...
```{r motif-cor-plot-2.2, eval=FALSE, include=FALSE, fig.width=5, fig.height=4, warning=FALSE}
# Plot motif enrichment (-log10 p-value) and correlation between motif enrichment (-log10 p-value) and gene scores
# Rank motifs by motif enrichment (-log10 p-value) and correlation between motif enrichment (-log10 p-value) and gene scores
...
* Plot motif enrichment (-log10 p-value) and gene scores
```{r motif-gene-plot-GATA-2.1, fig.width=8, fig.height=5, warning=FALSE}
plots <- create_motif_gene_scatterplot(motif_res, genescore_res, 
                                       motif_gene_table,
                                       k = 4, 
                                       y = "-log10(p-value)", 
...
* Plot motif enrichment (zscore) and gene scores
```{r motif-gene-plot-GATA-2.2, fig.width=8, fig.height=5, warning=FALSE}
...
* Plot motif enrichment (-log10 p-value) and gene scores
```{r motif-gene-plot-CEBP-2.1, fig.width=8, fig.height=5, warning=FALSE}
plots <- create_motif_gene_scatterplot(motif_res, genescore_res, 
                                       motif_gene_table,
                                       k = 1, 
                                       y = "-log10(p-value)", 
...
* Plot motif enrichment (zscore) and gene scores
```{r motif-gene-plot-CEBP-2.2, fig.width=8, fig.height=5, warning=FALSE}
plots <- create_motif_gene_scatterplot(motif_res, genescore_res, 
                                       motif_gene_table,
                                       k = 1, 
                                       y = "z-score", 
...
* Plot motif enrichment (zscore) and gene scores
```{r motif-gene-plot-GATA-3.2, fig.width=8, fig.height=5, warning=FALSE}
...
* Plot motif enrichment (zscore) and gene scores
```{r motif-gene-plot-CEBP-3.2, fig.width=8, fig.height=5, warning=FALSE}
plots <- create_motif_gene_scatterplot(motif_res, genescore_res, 
                                       motif_gene_table,
                                       k = 1, 
                                       y = "z-score", 
...
* Plot motif enrichment (zscore) and gene scores
```{r motif-gene-plot-GATA-4.2, fig.width=8, fig.height=5, warning=FALSE}
...
* Plot motif enrichment (zscore) and gene scores
```{r motif-gene-plot-CEBP-4.2, fig.width=8, fig.height=5, warning=FALSE}
plots <- create_motif_gene_scatterplot(motif_res, genescore_res, 
                                       motif_gene_table,
                                       k = 1, 
                                       y = "z-score", 
