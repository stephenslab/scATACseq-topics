...
Compare to the PCA hexbin plots, 
the clusters defined by k-means on topic proportions (below)
reasonably identify the clusters shown in PCA.
...
<!-- p36 <- ggplot(freq_cluster_cell, aes(fill=cell_label, y=freq, x=cluster_kmeans)) +  -->
<!--   geom_bar(position="stack", stat="identity") + -->
<!--   theme_classic() + xlab("Cluster") + ylab("Number of cells") + -->
