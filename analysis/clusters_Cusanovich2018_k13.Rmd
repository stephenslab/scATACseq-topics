...
- cluster c13 is also from whole brain and cerebellum.
...
```{r freq-table-cluster-tissue, fig.width=7, fig.height=5}
...
```{r freq-table-cluster-celllabel, fig.width=7, fig.height=9}
