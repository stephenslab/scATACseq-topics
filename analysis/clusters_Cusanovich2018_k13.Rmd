...
```{r structure-plot-c2-1, fig.width=7, fig.height=2}
...
```{r pca-c2, fig.width=6, fig.height=3}
breaks <- c(0,1,5,10,100,Inf)
...
Group samples by tissue labels first, then by cell labels
```{r structure-plot-c5-1, fig.width=7, fig.height=2}
...
```{r pca-c5, fig.width=6, fig.height=3}
breaks <- c(0,1,5,10,100,Inf)
...
Group samples by tissue labels first, then by cell labels
```{r structure-plot-c15-1, fig.width=7, fig.height=2}
...
```{r pca-c15, fig.width=6, fig.height=3}
breaks <- c(0,1,5,10,100,Inf)
...
Group samples by tissue labels first, then by cell labels
```{r structure-plot-c6-1, fig.width=7, fig.height=2}
...
```{r pca-c6, fig.width=6, fig.height=3}
breaks <- c(0,1,5,10,100,Inf)
