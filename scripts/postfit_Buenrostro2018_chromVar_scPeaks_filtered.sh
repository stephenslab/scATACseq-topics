...
# Data processed using chromVAR in aggregated single-cell peaks from Chen 2019 which were also filtered requiring accessible > 1% samples
# ---------------------------------------------------------------------------------------------------------------------------------------
# Settings
DAT_DIR=/project2/mstephens/kevinluo/scATACseq-topics/data/Buenrostro_2018/processed_data_Chen2019pipeline/chromVAR/
FIT_DIR=/project2/mstephens/kevinluo/scATACseq-topics/output/Buenrostro_2018_chromVAR_scPeaks_filtered/binarized/
OUT_DIR=/project2/mstephens/kevinluo/scATACseq-topics/output/Buenrostro_2018_chromVAR_scPeaks_filtered/binarized/
...
sbatch --mem=10G ~/projects/scATACseq-topics/scripts/postfit_gene_analysis.sbatch \
       ${DAT_DIR}/Buenrostro_2018_binarized_scPeaks_filtered.RData \
